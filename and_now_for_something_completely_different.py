class Matrices:
    """
    Membuat parameter untuk input
    ukuran colom dan baris
    """
    ...
    def ubah(self, col, row):
        ...
        """
        Membuat output strip menyesuaikan
        ukuran matrik
        """
        ...
        """
        Membuat output baris angka
        menyesuaikan ukuran matrik
        """
...
pemanggilan method
"""
matrik = Matrices(int(dimensi_row), int(dimensi_col))
matrik.output()
